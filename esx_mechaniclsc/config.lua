...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -205.4544, y = -1339.6572, z = 34.8995 }, -- , , , 146.1674
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 27, g = 22, b = 90 },
		Type  = 27
	},
	-- Garage = {
	-- 	Pos   = { x = -1428.2431640625, y = -453.29428100586, z = 35.909725189209 },
	-- 	Size  = { x = 1.5, y = 1.5, z = 1.0 },
	...
	VehicleSpawnPoint = {
		Pos   =  { x = -227.6935, y = -1279.6638, z = 31.2966 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},
	VehicleCarSpawnPoint = {
		Pos   = { x =  -228.0557, y = -1289.4819, z =  30.2966 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 27, g = 22, b = 90 },
		Type  = 27
	},
	VehicleDeleter = {
		Pos   = { x = -228.3107, y = -1264.8037, z = 31.2966 },
		Size  = { x = 4.0, y = 4.0, z = 5.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1
	},
	VehicleDelivery = {
