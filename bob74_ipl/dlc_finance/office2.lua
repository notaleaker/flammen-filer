...
FinanceOffice2 = {
    ...
    LoadDefault = function()
        ...
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Cash, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Guns.C, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.FurCoats.C, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.FurCoats.C, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Electronic, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Jewel, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Gems, false, true)
        FinanceOffice2.Swag.Enable(FinanceOffice2.Swag.Ivory, false, true)
        FinanceOffice2.Safe.Close("left")
    end
}
