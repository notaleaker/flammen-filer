...
FinanceOffice3 = {
    ...
    LoadDefault = function()
        FinanceOffice3.Style.Set(FinanceOffice3.Style.Theme.contrast)
        FinanceOffice3.Chairs.Set(FinanceOffice3.Chairs.on, true)
        SetIplPropState(FinanceOffice3.currentInteriorId, "swag_gems", true, true)
        SetIplPropState(FinanceOffice3.currentInteriorId, "swag_jewelwatch3", true, true)
        SetIplPropState(FinanceOffice3.currentInteriorId, "swag_silver", true, true)
    end
}
