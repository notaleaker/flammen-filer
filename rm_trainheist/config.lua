...
Config['TrainHeist'] = {
    ...
    ['reward'] = {
        ...
        sellPrice = 17000 -- buyer sell price
    },
...
Strings = {
    ['start_heist'] = 'Tryk ~INPUT_CONTEXT~ for at starte Train Heistet',
    ['cutting'] = 'Tryk ~INPUT_CONTEXT~ for at skære',
    ['grab'] = 'Tryk ~INPUT_CONTEXT~ for at tag guldet',
    ['start_heist'] = 'Tryk ~INPUT_CONTEXT~ for at starte Train Heistet',
    ['goto_ambush'] = 'Gå til bagholdspunktet i GPS. Dræb vagterne, gennemsøg Merryweather-containere og stjæl guld.',
    ['wait_nextrob'] = 'Du skal vente med at klæde dig af igen',
    ['minute'] = 'minutter.',
    ['ambush_blip'] = 'Amubsh Point',
    ['need_this'] = 'Du har brug for dette: ',
    ['deliver_to_buyer'] = 'Lever byttet til køberen. Tjek gps.',
    ['buyer_blip'] = 'Køberen',
    ['need_police'] = 'Der ikke nok Politi i byen!',
    ['total_money'] = 'Du har dette: ',
    ['police_alert'] = 'Tog Røveri! Skynd jer der hen inden de slipper væk.',
}
