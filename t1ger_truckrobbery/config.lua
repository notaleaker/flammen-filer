...
Config.TruckRobbery = {
	...
	cooldown = 720,						-- set cooldown time in minutes, before a player can start a job again

	police = {	-- police settings
		jobs = {"police", "lspd"},		-- Jobs that can't do criminal things etc.
		minCops = 4,					-- required police online for players to do jobs
	...
	computer = {  -- job settings (where u start the job)
		pos = {859.4728, -2491.7410, 28.3926, 261.8291},		-- pos for computer to hack
		blip = {enable = false, sprite = 47, display = 4, scale = 0.65, color = 5, label = 'Truck Robbery Job'},
	...
	rob = {
		detonateTimer = 15, 					-- time until bomb is detonated
		takeLootTimer = 20, 					-- time spent to loot the truck
	...
	reward = {
		money = {dirty = true, min = 300000, max = 600000}, -- dirty money or cash, min amunt and max amount of cash.
		items = {
			enable = true,			-- enable/disable item rewards
			list = {
				[1] = {item = 'accesscard', min = 1, max = 2, chance = 10},
				[2] = {item = 'goldbar', min = 1, max = 3, chance = 30},
				[3] = {item = 'goldwatch', min = 1, max = 5, chance = 50},
				[3] = {item = 'goldnecklace', min = 1, max = 5, chance = 40},
...
Config.TruckSpawns = {
	[1] = {
		...
		security = {
			...
			[4] = {ped = 's_m_m_security_01', seat = 2, weapon = 'WEAPON_COMBATPISTOL'},
		},
	},
	[2] = {
