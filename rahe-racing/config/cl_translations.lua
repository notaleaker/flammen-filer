clConfig.translations = {
    LABEL_RACE_START_TRACKTYPE_SPRINT = 'Sprint',
    LABEL_RACE_START_TRACKTYPE_CIRCUIT = 'Circuit',
    ...
    NOTIFICATION_TABLET_COMPETITION_STARTING = 'Competition created, the start is in 1 hour.',
