...
window.addEventListener('message', function(event) {
	...
	switch (event.data.action) {
		...
		case 'buyBusiness':
			...
			$("#shop_price").html(`${numberWithSpaces(event.data.price)}kr`);
		...
		case 'verifySell':
			...
			$('#sellvehicle_price').html(numberWithSpaces(sellvehicle_payment)+"kr");
								...
								<div class="row" style="height: 110px;">
									...
									<div class="col col-md-3 d-flex justify-content-center" style="padding-left: 8px; padding-right: 8px;">
										<div class="card w-100 text-center justify-content-center" style="background-color: #1f5eff;">
											...
											<div style="font-size: 20px;">${numberWithSpaces(admin_totalMoney)}kr</div>
										</div>
									</div>
									<div class="col col-md-3 d-flex justify-content-center" style="padding-left: 8px; padding-right: 8px;">
										<div class="card w-100 text-center justify-content-center" style="background-color: #1f5eff;">
...
function vehicles_overview() {
	...
	for(var i = 0; i < num; i++) {
		...
		row += `<tr>
					...
					<td class="text-center align-middle">${admin_vehicles[i].min_price}kr</td>
					<td class="text-center align-middle">${admin_vehicles[i].max_price}kr</td>
					<td class="text-center align-middle"><button type="button" class="btn btn-blue btn-edit" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-edit"></i> EDIT</button></td>
				</tr>`
...
$(document).on('click', "#saleshistory_page", function() {
	...
	for(var i = 0; i < num; i++) {
		row += `<tr style="height: 65px;">
					...
					<td class="text-center align-middle">${numberWithSpaces(allSalesTable[i].price)}kr</td>
...
function updateEmployees() {
	...
	for(var i = 0; i < num2; i++) {
			...
			<div class="col-md-3">
				<div class="card item_card">
					<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
						<div class="expiration-time"><span>Earned: ${employeesList[i].earned}kr</span></div>
		...
		if(!myEle){
					...
					<div class="modal-dialog modal-dialog-centered" style="width: 400px;">
						<div class="modal-content myinvoices_modal-content">
							<div class="modal-body p-4 text-center">
								...
								<div class="modal-title" id="${earned_id}" style="font-weight: 500;">Total Earned: ${employeesList[i].earned}kr</div>
			...
			$("#"+earned_id).html(`Total Earned: ${employeesList[i].earned}kr`);
			$("#"+fire_btns).html(`
				<a id="cancelAction" href="#" class="btn btn-dark d-block w-50" style="border-radius: 10px; font-size: 30px; margin-right: 15px;" data-bs-dismiss="modal"><i class="fas fa-times"></i> CANCEL</a>
				<a id="fire_employee" href="#" class="btn btn-blue d-block w-50" style="border-radius: 10px; font-size: 30px;" data-id="${employeesList[i].identifier}" data-shop_id="${employeesList[i].shop_id}"><i class="fas fa-shopping-cart"></i> FIRE</a>
			`);
...
function updatePriceTable() {
	...
	for(var i = 0; i < num; i++) {
		...
		row += `<tr>
					...
					<td class="text-center align-middle">${numberWithSpaces(catalog[i].price)}krr</td>
					<td class="text-center align-middle"><button type="button" class="btn btn-blue btn-edit" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-edit"></i> EDIT</button></td>
				</tr>`
		...
		if(!myEle){
					...
					<div class="modal-dialog modal-dialog-centered" style="width: 400px;">
						<div class="modal-content myinvoices_modal-content">
							<div class="modal-body p-4 text-center">
								...
								<div class="modal-title" style="font-weight: 500;">Current Price: ${numberWithSpaces(catalog[i].price)}kr</div>
								<div class="modal-title" style="font-weight: 500;">Min. Price: ${numberWithSpaces(catalog[i].min_price)}kr</div>
								<div class="modal-title" style="font-weight: 500;">Max. Price: ${numberWithSpaces(catalog[i].max_price)}kr</div>
			...
			$('#'+modal_min).html(`Min. Price: ${numberWithSpaces(catalog[i].min_price)}kr`);
			$('#'+modal_max).html(`Max. Price: ${numberWithSpaces(catalog[i].max_price)}kr`);
		}
	}
	...
	for(var i = 0; i < num; i++) {
		if(orders[i].employee_id == "" && orders[i].employee_name == "") {
			row += `<tr style="height: 65px;">
						...
						<td class="text-center align-middle">${numberWithSpaces(orders[i].reward)}kr</td>
					...
					<div class="card item_card">
						<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
							...
							<div class="item_card-spacer">
								<div class="item-price text-center">${numberWithSpaces(catalog[i].price)} kr</div>
			...
			<div class="col-md-3">
				<div class="card item_card">
					<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
						...
						<img src="img/${vehicle_image}.png" class="image">
						<div class="item_card-spacer" style="margin-bottom: -50;">
							<div class="item-price text-center">${numberWithSpaces(vehicles[i].owner_buy_price)} kr</div>
					...
					<div class="modal-dialog modal-dialog-centered" style="width: 400px;">
						<div class="modal-content myinvoices_modal-content">
							<div class="modal-body p-4 text-center">
								...
								<hr>
								<div class="text-center modal-title" style="font-weight: 500;">${vehicles[i].vehicle_name} for ${numberWithSpaces(vehicles[i].owner_buy_price)}kr</div>
...
$(document).on('click', ".catalog-item_body-vehicle", function() {
	...
	$('#vehicle_price_modal').html(numberWithSpaces($(this).data("price"))+"kr");
	...
	$.post('https://okokVehicleShop/action', JSON.stringify({
		...
		price: numberWithSpaces($(this).data("price"))+"kr",
	}));
});
					...
					<div class="col-md-3">
						<div class="card item_card">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="img/${vehicle_image}.png" class="image">
								<div class="item_card-spacer">
									<div class="item-price text-center">${numberWithSpaces(list[i].price)} kr</div>
				...
				<div class="col-md-3">
					<div class="card item_card">
						<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
							...
							<img src="img/${vehicle_image}.png" class="image">
							<div class="item_card-spacer" style="margin-bottom: -50;">
								<div class="item-price text-center">${numberWithSpaces(list[i].owner_buy_price)} kr</div>
								<div class="item-title text-center">${list[i].vehicle_name}</div>
							</div>
						</div>
						<a href="#" class="btn btn-blue d-block item_card-btn" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-shopping-cart"></i> BUY</a>
						...
						<div class="modal-dialog modal-dialog-centered" style="width: 400px;">
							<div class="modal-content myinvoices_modal-content">
								<div class="modal-body p-4 text-center">
									<div class="modal-title">Buy Vehicle</div>
									<hr>
									<div class="text-center modal-title" style="font-weight: 500;">${list[i].vehicle_name} for ${numberWithSpaces(list[i].owner_buy_price)}kr</div>
									<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeBuyVehicleModal"></button>
									<div class="d-flex justify-content-center flex-column">
										<input type="number" id="${input_id}" class="form-control flex-grow-1 text-center" placeholder="Amount">
	...
	for(var i = 0; i < num; i++) {
		...
		if (str.includes(word)) {
			...
			row += `<tr>
						...
						<td class="text-center align-middle">${numberWithSpaces(list[i].price)}kr</td>
						<td class="text-center align-middle"><button type="button" class="btn btn-blue btn-edit" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-edit"></i> EDIT</button></td>
					</tr>`
			...
			if(!myEle){
						...
						<div class="modal-dialog modal-dialog-centered" style="width: 400px;">
							<div class="modal-content myinvoices_modal-content">
								<div class="modal-body p-4 text-center">
									...
									<div class="modal-title" style="font-weight: 500;">Current Price: ${numberWithSpaces(list[i].price)}kr</div>
									<div class="modal-title" id="${modal_min}" style="font-weight: 500;">Min. Price: ${numberWithSpaces(list[i].min_price)}kr</div>
									<div class="modal-title" id="${modal_max}" style="font-weight: 500;">Max. Price: ${numberWithSpaces(list[i].max_price)}kr</div>
									<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" id="closeEditPriceModal"></button>
									<div class="d-flex justify-content-center flex-column">
										<input type="number" id="${input_id}" class="form-control flex-grow-1 text-center" placeholder="New Price">
				...
				$('#'+modal_min).html(`Min. Price: ${numberWithSpaces(list[i].min_price)}kr`);
				$('#'+modal_max).html(`Max. Price: ${numberWithSpaces(list[i].max_price)}kr`);
			}
		}
	}
	...
	for(var i = 0; i < num; i++) {
		...
		if (str.includes(word)) {
			...
			row += `<tr>
						...
						<td class="text-center align-middle">${list[i].min_price}kr</td>
						<td class="text-center align-middle">${list[i].max_price}kr</td>
						<td class="text-center align-middle"><button type="button" class="btn btn-blue btn-edit" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-edit"></i> EDIT</button></td>
					</tr>`
