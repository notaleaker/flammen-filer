...
Config.NPCJobEarnings             = { min = 5000, max = 15000 }
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = 542.9715, y = -203.5631, z = 54.3889 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},
	--  Garage = {
	--  	Pos   = { x = -1427.0249, y = 5.3695, z = 51.6211 },
	--  	Size  = { x = 1.5, y = 1.5, z = 1.0 },
	--  	Color = { r = 204, g = 204, b = 0 },
	--  	Type  = 1
	--  },
	...
	-- },
	VehicleSpawnPoint = {
		Pos   = {x = 547.1275, y = -210.6069, z = 53.5026},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 537.4554, y = -240.0457, z = 49.5553},
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1
	},
	VehicleDelivery = {
		Pos   = { x = 542.5013, y = -230.6694, z = 50.3134 },
