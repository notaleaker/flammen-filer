...
Config.UseCalculatedPrice = true
Config.DefaultRepairPrice = 20000
...
Config.Zones = {
	...
	--[[ls7 = {
		Pos   = { x = 545.1198, y = -189.6898, z = 54.4932},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('autoexotic'),
	...
	ls8 = {
		Pos   = { x = -960.0298, y = -2972.1230, z = 13.9329}, ---975.8101, -2959.4893, 13.9451, 350.3571
	...
	ls9 = {
		Pos   = { x = 548.5272, y = -198.6678, z = 54.4932}, -- 548.5272, -198.6678, 54.4932, 356.5865
		Size  = {x = 10.0, y = 10.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('autoexotic'),
...
Config.Menus = {
	...
	-- Husk at justere priserne i bilshoppen!!!!!
	modEngine = {
		label = _U('engine'),
		parent = 'upgrades',
		modType = 11,
		price = {50.0, 75.0, 100.0, 130.0}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {25.0, 45.0, 65.0, 85.0}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {50.0, 75.0, 90.0, 100.0}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {20.0, 35.0, 45.0, 65.0, 75.0}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {40.0, 50.0, 55.0, 65.0, 80.0, 100.0}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	cosmetics = {
		...
		interior			= _U('interior'),
		windowTint			= _U('windowtint'),
		modHorns			= _U('horns'),
		neonColor			= _U('neons'),
		resprays			= _U('respray'),
		headLights			= _U('headlights'),
	...
	headLights = {
		label = _U('headlights'),
		parent = 'cosmetics',
		modXenon = _U('modXenon'),
		modHeadlight = _U('modHeadlight')
	},
	
	interior = {
		label 				= _U('interior'),
		parent 				= 'cosmetics',
		modTrimA			= _U('interiortrim'),
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType8	= "Benny's Original",
		modFrontWheelsType9	= "Benny's Bespoke",
	...
	modHeadlight = {
		label = _U('modHeadlight'),
		parent = 'headLights',
		modType = 'modHeadlight',
		price = 1.20
	},
	bodyparts = {
		label = _U('bodyparts'),
