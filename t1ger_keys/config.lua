...
Config = {
    ...
    Police = {
        ...
        EnableAlerts    = false,                     -- enable police alerts on car stealing
	...
	CarMenu = {
		Key				= 244,     -- 170   	    -- key to open car menu (DEFAULT: [F3]), set to 0 to disable.
		Command 		= 'carmenu',				-- command to open car menu, set to '' to disable
	},

	Engine = {
		Key				= 0,     -- 311     		    -- key to toggle engine on/off (DEFAULT: [K]), set to 0 to disable.
    ...
    Search = {
        ...
        Items = {
			   [1] = {item = 'coke', name = 'Kokain', chance = 67, amount = {min = 2, max = 7}},
           	   [2] = {item = 'rolpaper', name = 'Rullepapir', chance = 50, amount = {min = 1, max = 3}},
...
Config.AlarmShop = {
    ...
    bank = true,                            -- pay in bank money, false is normal cash
    price = 5,                             -- prices is based on % of vehicle price, where 10 means 10% of vehicle price
