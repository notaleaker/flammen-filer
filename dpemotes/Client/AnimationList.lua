...
DP.Emotes = {
   ...
   ["fallover"] = {"mp_suicide", "pistol", "Fall Over "},
   ["fallover2"] = {"mp_suicide", "pill", "Fall Over 2"},
   ["fallover3"] = {"friends@frf@ig_2", "knockout_plyr", "Fall Over 3"},
   ["fallover4"] = {"anim@gangops@hostage@", "victim_fail", "Fall Over 4"},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["pizza"] = {"anim@heists@box_carry@", "idle", "Pizza", AnimationOptions =
   {
       Prop = "prop_pizza_box_03",
       PropBone = 28422,
       PropPlacement = {0.65, -0.2, -0.15, 0.0, 0.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
}
...
DP.JobEmotes = {
    ["spoiler"] = {"anim@heists@box_carry@", "idle", "Spoiler", AnimationOptions =
    {
        ...
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.05, 0.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["front_bumpers"] = {"anim@heists@box_carry@", "idle", "Front bumpers", AnimationOptions =
    {
        Prop = "imp_prop_impexp_front_bumper_01a",
        PropBone = 28422,
        PropPlacement = {0.0, 0.05, -0.05, 0.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["rear_bumpers"] = {"anim@heists@box_carry@", "idle", "Rear bumpers", AnimationOptions =
    {
        Prop = "imp_prop_impexp_rear_bumper_03a",
        PropBone = 28422,
        PropPlacement = {0.0, -0.03, -0.05, 0.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["exhaust"] = {"anim@heists@box_carry@", "idle", "Exhaust", AnimationOptions =
    {
        ...
        PropBone = 28422,
        PropPlacement = {0.05, -0.2, -0.2, 0.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["rollcage"] = {"anim@heists@box_carry@", "idle", "Roll Cage", AnimationOptions =
    {
        Prop = "imp_prop_impexp_rear_bars_01b",
        PropBone = 28422,
        PropPlacement = {0.05, -0.6, -0.6, 0.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["hood"] = {"anim@heists@box_carry@", "idle", "Hood", AnimationOptions =
    {
        Prop = "imp_prop_impexp_bonnet_02a",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.2, 100.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["fenders"] = {"anim@heists@box_carry@", "idle", "Fenders", AnimationOptions =
    {
        Prop = "imp_prop_impexp_car_panel_01a",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.2, 0.0, 0.0, 90.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["brakes"] = {"anim@heists@box_carry@", "idle", "Brakes", AnimationOptions =
    {
        Prop = "imp_prop_impexp_brake_caliper_01a",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.2, 100.0, 0.0, 90.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["transmission"] = {"anim@heists@box_carry@", "idle", "Transmission", AnimationOptions =
    {
        Prop = "imp_prop_impexp_gearbox_01",
        PropBone = 28422,
        PropPlacement = {0.0, 0.1, -0.2, 100.0, 90.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["headlights"] = {"anim@heists@box_carry@", "idle", "Head Lights", AnimationOptions =
    {
        Prop = "v_ind_tor_bulkheadlight",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.2, 100.0, 180.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ...
    {
        Prop = "prop_tornado_wheel",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, 0.1, 100.0, 0.0, 90.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["seat"] = {"anim@heists@box_carry@", "idle", "Seat", AnimationOptions =
    {
        Prop = "prop_car_seat",
        PropBone = 28422,
        PropPlacement = {0.0, -0.1, -0.2, 20.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["trunk"] = {"anim@heists@box_carry@", "idle", "Trunk", AnimationOptions =
    {
        Prop = "imp_prop_impexp_trunk_01a",
        PropBone = 28422,
        PropPlacement = {0.0, -0.2, 0.5, 90.0, 0.0, 0.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["door"] = {"anim@heists@box_carry@", "idle", "Door", AnimationOptions =
    {
        Prop = "imp_prop_impexp_car_door_04a",
        PropBone = 28422,
        PropPlacement = {-0.5, -0.2, 0.0, 0.0, 0.0, 90.0},
        --
        EmoteLoop = true,
        EmoteMoving = true,
    }},
