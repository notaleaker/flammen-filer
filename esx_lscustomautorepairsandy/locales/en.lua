Locales['en'] = {
  ...
  ['already_own'] = 'Du ejer allerede: ~b~%s~s~',
  ['not_enough_money'] = 'Du har ikke nok penge!',
  ['purchased'] = '~g~Du betalte for dine opgraderinger!',
  ['press_custom'] = 'Tryk ~INPUT_PICKUP~ for at ~y~customise~s~ dit køretøj.',
  ['level'] = 'level %s',
  ['neon'] = 'neon',
  ['blip_name'] = 'San Andreas Customs',
  ['lscustom'] = 'Los Santos Customs',
  ['autoexotic'] = 'Auto Exotic',
  ['benny'] = 'Bennys Motorworks',
  ['autorepair'] = 'Auto Repair Sandy',
  ['workshop'] = 'Mekaniker',
  ['yes'] = 'Ja',
  ['no'] = 'Nej',
  ['repair'] = 'Reparer køretøj ',
  ['repaired'] = 'Du reparerede dit køretøj for ~g~DKK%s',
  ['no_permission'] = '~r~Du har ikke tilladelse til denne shop!',
  ['totalprice'] = 'Den totale pris for dine opgraderinger er ~g~DKK%s',
  ['totalpricemechanic'] = 'Den totale pris for opgraderinger er ~g~DKK%s~s~ | Normal pris ~g~DKK%s',
  ['buyupgrades'] = 'Ønsker du og købe disse opgraderinger?',
  ['choose'] = '~r~Du skal vælge her!',
-- Paint Colors
  -- Black
  ['black'] = 'black',
  ['graphite'] = 'graphite',
...
-- Cosmetics
  ...
  ['modXenon'] = 'xenon lights',
  ['modHeadlight'] = 'headlight color',
  ...
  ['trunk'] = 'trunk',
  ['hydraulic'] = 'hydraulic',
  ['engine_block'] = 'Motorblokken',
  ['air_filter'] = 'Luft filter',
  ['struts'] = 'struts',
