...
Config = {
	...
	CashInDirty = false, -- safe rewards in dirty (black_money) or normal cash?
	AlertBlip = { Show = true, Time = 40, Radius = 50.0, Alpha = 250, Color = 3 }
}
...
Config.Banks = {
	[1] = {
		...
		doors = {
			...
			['front'] = {pos = vector3(257.01,220.54,106.29), model = -222270721, heading = 340.0, setHeading = 340.0, freeze = true, action = 'lockpick', offset = vector3(1.19,0.0,0.0)},
			['top'] = {pos = vector3(265.58, 217.78, 110.28), model = 1956494919, heading = 340.0, setHeading = 340.0, freeze = true, action = 'lockpick', offset = vector3(0,0,0)}
		...
		safes = {
			[1] = {
				...
				requireDoor = 'cell',
				items = {
					{name = 'goldwatch', amount = {min = 1, max = 3}, chance = 50},
					{name = 'goldbar', amount = {min = 1, max = 2}, chance = 20},
					-- add more items here 
				},
				cash = {enable = true, min = 140000, max = 180000},
			},
			[2] = {
		...
		crackSafe = {
			...
			combinations = {	-- set amount of locks to crack
				...
				[2] = {min = 50, max = 99},	
				[3] = {min = 20, max = 99},-- min 0 and max 99 
				-- add more if u want..
			},
			reward = {
				items = {
					{name = 'accesscard', amount = {min = 1, max = 1}, chance = 20},
					{name = 'goldwatch', amount = {min = 1, max = 3}, chance = 50},
					{name = 'goldbar', amount = {min = 1, max = 2}, chance = 20},
					-- add more items here 
				},
				cash = {enable = true, min = 40000, max = 60000}
			},
		...
		reqItems = { -- required items for pacific & settings:
			...
			['drilling'] = { -- do not touch ID's
				{name = 'drill', amount = 1, remove = false, chance = 90}, -- item name, amount required, remove/not remove, chance to remove in %.
				-- add more items with same layout if u want
			},
	...
	[2] = {
		...
		safes = {
			[1] = {
				...
				requireHack = 'vault',
				items = {
					{name = 'goldwatch', amount = {min = 1, max = 5}, chance = 60},
					{name = 'goldbar', amount = {min = 1, max = 3}, chance = 30},
					{name = 'goldnecklace', amount = {min = 1, max = 4}, chance = 50},
					-- add more items here 
				},
				cash = {enable = true, min = 100000, max = 120000},
			},
			[2] = {
			...
			[5] = {
				...
				cash = {enable = true, min = 80000, max = 10000}
			},
		},
		...
		powerBox = {
			...
			disabled = false, -- do not touch!
			freeTime = 120, -- time in seconds before police is alerted
			hackAdd = {enable = true, time = 30}, -- extra time added upon successful hacking
		},
